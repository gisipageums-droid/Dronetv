      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-ink">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-px bg-ink-charcoal border-2 border-ink-charcoal rounded overflow-hidden">
            {[
              { tag:'Video', tagColor:'bg-status-error/60 text-status-error/40', title:'Video Interview (5-min)', desc:"CEO, technical lead, or product interviews for Drone, GIS, and AI companies. Published on YouTube and embedded on the company's DroneTv profile.", detail:'Brand: 1 | Expand: 2 | Promoted via social on publish week' },
              { tag:'Video', tagColor:'bg-status-error/60 text-status-error/40', title:'Short Reel (1-min)', desc:'Product reels, service showcases, or technology demos for all three sectors. Published on Instagram, Facebook, and cross-posted on LinkedIn.', detail:'Brand: 2 reels | Expand: 4 reels | All handles simultaneously' },
              { tag:'Social', tagColor:'bg-status-info/60 text-status-info/40', title:'Promotional Posts', desc:'Company posts published across LinkedIn, Instagram, and Facebook for Drone, GIS, and AI companies. Company tagged, website link included.', detail:'Reach: 2 (one-time) | Brand: 6/yr | Expand: 12/yr' },
              { tag:'Article', tagColor:'bg-status-success/60 text-status-success/40', title:'Editorial Articles', desc:'600–1000 word articles about the company — Drone technology, GIS methodology, AI solutions — published on DroneTv.in and promoted via social.', detail:'Brand: 1 article | Expand: 3 articles | Promoted on publish day' },
              { tag:'News', tagColor:'bg-status-success/60 text-status-success/40', title:'DroneTv News Posts', desc:'Short platform news posts for company announcements, product launches, certifications, and milestones — all three sectors.', detail:'Expand: up to 6/year | Company-specific items' },
              { tag:'PR', tagColor:'bg-status-success/60 text-status-success/40', title:'Press Releases', desc:'Press releases written and published on DroneTv.in for Drone, GIS, and AI company announcements and major news.', detail:'Expand: up to 6/yr | Add-on: ₹3,000 each' },
              { tag:'Social', tagColor:'bg-status-info/60 text-status-info/40', title:'Event Coverage Posts', desc:'Social posts covering product launches, awards, and exhibitions for Expand subscribers across Drone, GIS, and AI sectors.', detail:'Expand package only | Launches, awards, exhibitions' },
              { tag:'Magazine', tagColor:'bg-brand-gold/60 text-brand-yellow-soft', title:'Magazine Placements', desc:"Magazine advertisements, editorial articles, and cover page features in DroneTv's quarterly magazine — open to Drone, GIS, and AI companies equally.", detail:'Brand: Half-page x2 | Expand: Full-page x4 + editorial' },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-ink-light border-2 border-ink-light rounded overflow-hidden">
            {[
              ...
              { badge:<Chip label="Brand" color="bg-ink text-brand-yellow" />, title:'Notification + Monthly Report', bullets:['Email notification on new enquiry','Login to view full details','Monthly enquiry count and profile views','All three sectors covered'] },
              { badge:<Chip label="Expand" color="bg-status-error text-white" />, title:'Full Buyer Data + Analytics', bullets:['Email notification on new enquiry','Full buyer name, company, email, phone on platform','Monthly analytics across all sectors','Listing performance data'] },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-ink-light border-2 border-ink-light rounded overflow-hidden mb-8">
            ...
            <div className="bg-ink text-white p-6">
              ...
              <div className="text-xl font-extrabold text-brand-yellow mb-1">Brand</div>
            ...
            <div className="bg-surface-card p-6">
              ...
              <div className="text-xl font-extrabold text-ink mb-1">Expand</div>
            ...
            <table className="w-full text-xs border-collapse min-w-[500px]">
              <thead>
                <tr>
                  ...
                  {['Reach','Brand','Expand'].map(h => <th key={h} className="bg-ink text-brand-yellow font-bold py-3 px-3 text-center text-[10.5px] tracking-wider">{h}</th>)}
                </tr>
              </thead>
              <tbody>
                {[
