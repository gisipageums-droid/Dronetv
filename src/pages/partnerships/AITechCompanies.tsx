    ...
    <div className="pt-[104px] min-h-screen bg-gray-50">
      <div className="bg-black text-white relative">
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-2">AI Tech <span className="text-yellow-400">Companies</span></h1>
            <p className="text-sm text-white/60 max-w-lg">AI software platforms, computer vision companies, and deep-tech enablers powering India's autonomous drone ecosystem.</p>
          </div>
          <div className="flex-shrink-0">
            <span className="text-4xl font-extrabold text-yellow-400 block leading-none">{items.length}</span>
            <span className="text-xs text-white/50 font-semibold uppercase mt-1 block">Companies</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-12">
        {loading ? (
          ...
          <div className="text-center py-16 text-gray-400">No AI tech companies listed yet.</div>
        ) : (
