...
const packages = ['Reach — Rs.25,000/year + GST', 'Brand — Rs.75,000/year + GST', 'Expand — Rs.1,50,000/year + GST', 'Not sure yet'];
          ...
          <div>
            ...
            <div className="bg-white border border-gray-200 rounded-b-xl px-4 py-4 space-y-3">
              {[
                ...
                { name: 'Brand', price: 'Rs.75,000/yr', highlight: true },
                { name: 'Expand', price: 'Rs.1,50,000/yr', highlight: false },
              ].map((p) => (
