      ...
      <div className="bg-black text-white relative">
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-2">Drone <span className="text-yellow-400">Manufacturers</span></h1>
            <p className="text-sm text-white/60 max-w-lg">India's leading drone hardware manufacturers — agriculture sprayers, defence UAVs, survey platforms, and consumer drones.</p>
          </div>
          <div className="flex-shrink-0">
            <span className="text-4xl font-extrabold text-yellow-400 block leading-none">{items.length}</span>
            <span className="text-xs text-white/50 font-semibold uppercase mt-1 block">Manufacturers</span>
          </div>
        </div>
      </div>
