...
const whyPartner = [
  ...
  { icon: '🏛️', title: 'Expo Media Partnership', desc: 'DroneTv.in is the official Digital Broadcast Media Partner for major drone expos including Drone Expo 2026 Bengaluru. Expand partners receive expo stall branding credit and on-ground media coverage at DroneTv partner events.' },
  { icon: '📊', title: 'B2B Lead Generation', desc: 'Verified leads from buyers actively searching for your product or service category. Lead notification emails sent immediately. Expand package subscribers see full buyer contact details — name, company, email, and phone — directly on the platform.' },
  { icon: '📖', title: 'Magazine and Editorial Coverage', desc: "Brand and Expand partners receive advertising and editorial coverage in DroneTv's quarterly digital magazine — half-page or full-page ads, editorial articles, and cover page eligibility for Expand tier partners." },
