      ...
      <div className="bg-black text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-white leading-tight mb-3">Drone <span className="text-yellow-400">Expos</span></h1>
            <p className="text-sm text-white/60 max-w-lg">Trade shows and exhibitions showcasing India's latest drone technology, manufacturers, and service providers.</p>
          </div>
          <div className="flex gap-8 flex-shrink-0">
            <div>
              <span className="text-4xl font-extrabold text-yellow-400 block leading-none">{events.length || '0'}</span>
              <span className="text-xs text-white/50 font-semibold uppercase tracking-wide mt-1 block">Expos</span>
            </div>
            <div>
              <span className="text-4xl font-extrabold text-yellow-400 block leading-none">Live</span>
              <span className="text-xs text-white/50 font-semibold uppercase tracking-wide mt-1 block">Floor Coverage</span>
            </div>
          </div>
        </div>
      </div>
