      ...
      <div className="bg-black text-white relative">
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-2">Drone <span className="text-yellow-400">Expos</span></h1>
          ...
          <div className="flex-shrink-0">
            ...
            <span className="text-xs text-white/50 font-semibold uppercase mt-1 block">Expos</span>
          </div>
        </div>
      </div>
