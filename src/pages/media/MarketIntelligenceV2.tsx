...
import { Search, ChevronDown, Filter, ChevronLeft, ChevronRight, Grid3x3, List, Heart, Eye, Share2, Copy, BarChart3, Tag } from 'lucide-react';
...
const ReportCardV2: React.FC<{ item: MediaItem; onView: () => void }> = ({ item, onView }) => {
  ...
  const handleShare = (e: React.MouseEvent) => {
    e.stopPropagation();
    const url = `${window.location.origin}/media/market-intelligence/${item.contentId}`;
