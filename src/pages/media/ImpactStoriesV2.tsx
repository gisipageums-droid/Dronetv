...
const ImpactCardV2: React.FC<{ item: MediaItem; onRead: () => void }> = ({ item, onRead }) => {
  ...
  const handleShare = (e: React.MouseEvent) => {
    e.stopPropagation();
    const url = `${window.location.origin}/media/impact-stories/${item.contentId}`;
      ...
      <div className="flex flex-1 flex-col gap-2 p-4">
        ...
        <div className="mt-auto flex items-center justify-between gap-2 pt-1">
          <div className="flex items-center gap-3">
            ...
            <button type="button" onClick={handleShare} aria-label="Copy story link" className="flex shrink-0 items-center gap-1 text-xs font-semibold text-slate-500 hover:text-slate-700">
