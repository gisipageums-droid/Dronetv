        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: '📄', title: 'Half-Page Advertisement', desc: 'Half-page advertisement in 2 issues of DroneTv magazine. Professionally placed in relevant vertical sections.', badge: 'Brand Package', badgeColor: 'bg-status-info/15 text-status-info', note: '2 issues per year' },
              { icon: '📑', title: 'Full-Page Advertisement', desc: 'Full-page advertisement in all 4 quarterly issues plus 1 full editorial article (2–3 pages) in one selected issue. Cover page eligibility included.', badge: 'Expand Package', badgeColor: 'bg-brand-yellow-soft text-brand-gold', note: '4 issues + editorial article' },
              { icon: '🏆', title: 'Cover Page Feature', desc: 'Cover page feature photo eligibility for Expand package subscribers, subject to editorial schedule. The highest-visibility placement in the DroneTv media ecosystem.', badge: 'Expand Package Only', badgeColor: 'bg-status-warning/15 text-status-warning', note: 'Subject to editorial calendar' },
            ].map((item, i) => (
              <ContentCard key={i}>
