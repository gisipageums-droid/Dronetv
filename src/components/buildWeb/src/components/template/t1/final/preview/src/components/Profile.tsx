...
export default function CompanyProfile({profileData}) {
    ...
    const companyImageUrl = profileData?.companyImageUrl ||
                    ...
                    <div className="space-y-8">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-700 mt-4 max-w-xl">
                                Founded in <strong>{establishedYear}</strong>, {profileData?.companyName} || "Innovative Labs" is a global leader in delivering cutting-edge tech solutions that drive innovation and growth for businesses worldwide.
                            </p>
                        </motion.div>
