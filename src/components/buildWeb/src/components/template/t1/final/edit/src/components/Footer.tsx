...
export default function EditableFooter({ 
  ...
  // Initialize with data from props or use default structure matching the simple footer
  ...
  const handleSave = async () => {
    try {
      ...
      // Upload logo image if there's a pending one
      if (pendingLogoImage) {
        ...
        formData.append('file', pendingLogoImage);
        formData.append('sectionName', 'footer');
        formData.append('imageField', 'brand.logoUrl');
      ...
      // Update the data with the final logo URL
      const finalData = {
        ...tempData,
        brand: {
          ...tempData.brand,
      ...
      setIsEditing(false);
      setPendingLogoImage(null);
      toast.success('Footer saved successfully with S3 URLs');
                ...
                <div className='mb-4'>
                  ...
                  {pendingLogoImage && (
                    <p className="text-xs text-orange-600 mb-2">
                      Logo selected: {pendingLogoImage.name} (will upload on save)
                    </p>
                  )}
                  <label className='block text-xs text-gray-400 mb-1'>
                    Description:
              ...
              <div className='space-y-5 mb-10 text-sm'>
                <div className='flex items-start space-x-3 text-gray-300'>
                  ...
                  {isEditing ? (
                    ...
                    <span className="blur-[2px]">{tempData.contact.email}</span>
                  )}
                </div>
                ...
                <div className='flex items-start space-x-3 text-gray-300'>
                  ...
                  {isEditing ? (
                    ...
                    <span className="blur-[2px]">{tempData.contact.phone}</span>
                  )}
                </div>
                ...
                <div className='flex items-start space-x-3 text-gray-300'>
                  ...
                  {isEditing ? (
                    ...
                    <span className="blur-[2px]">{tempData.contact.address}</span>
                  )}
                </div>
              </div>
            </motion.div>
