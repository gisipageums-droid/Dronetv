...
export const Step1 = ({
  ...
  }, [data.basicInfo, data.addressInformation, data.alternateContact]);
  ...
  // Debug function for country/state updates
  const handleCountryStateUpdate = (section: string, field: string, value: string) => {
              ...
              <div className="md:col-span-2">
                <CountryStateSelect
                  ...
                  onCountryChange={(value) => {
                    console.log(`🟡 Country changed for ${section.id}:`, value);
                    handleCountryStateUpdate(section.id, "country", value);
                  }}
                  onStateChange={(value) => {
                    console.log(`🟡 State changed for ${section.id}:`, value);
                    handleCountryStateUpdate(section.id, "state", value);
                  }}
                  countryRequired={
