  ...
  return (
    <div className="bg-white border border-amber-200 rounded-xl p-4 date-picker-card animate-fade-in-up">
      ...
      <div className="relative">
        {/* Selection Highlight - Using first code's better height */}
...
export const Step1 = ({
  ...
  // Render a section
  const renderSection = (section: any) => {
    // 1. Safe Data Access - Using second code's better implementation
      ...
      >
        ...
        {useTwoColumns ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Country/State Selection - Using second code's better implementation */}
            {section.fields.some(
