...
export function Projects({ projectData, onStateChange, userId, publishedId, templateSelection }: ProjectsProps) {
  ...
  const processProjectsData = () => {
    ...
    return displayData.projects.map((project) => ({
      id: project.id,
      title: project.title,
  ...
  return (
    <section ref={projectsRef} id="projects" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {isEditing ? (
            ...
            <>
              ...
              >
                {displayData.heading || "Featured Projects"}
                {displayData.heading && !displayData.heading.includes("Projects") && (
        ...
        {/* Categories Filter */}
        {!isEditing && displayData.categories && displayData.categories.length > 0 && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.4 }}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {isEditing ? (
                    <input
                      type="text"
                      value={tempData.projects[index]?.title || ''}
                  ...
                  {isEditing ? (
                    <textarea
                      value={tempData.projects[index]?.description || ''}
                      ...
                      >
                        {isEditing ? (
                          <>
                            <input
                              type="text"
                              value={tempData.projects[index]?.tags[tagIndex] || ''}
                  ...
                  {isEditing ? (
                    <div className="grid grid-cols-2 gap-2 mb-4">
                      <input
                        type="text"
                        value={tempData.projects[index]?.category || ''}
                      ...
                      <input
                        type="text"
                        value={tempData.projects[index]?.date || ''}
                  ...
                  {isEditing ? (
                    <div className="flex flex-col space-y-2">
                      <input
                        type="text"
                        value={tempData.projects[index]?.live || ''}
                      ...
                      <input
                        type="text"
                        value={tempData.projects[index]?.github || ''}
        ...
        {/* Add project button when editing and no projects */}
        {isEditing && filteredProjects.length === 0 && (
          <div className="text-center py-12">
            <Button
              onClick={addProject}
              variant='outline'
        ...
        >
          <AnimatedButton href="#contact" size="lg">
            {displayData.projects && displayData.projects.length > 0 ? "View All Projects" : "Get In Touch"}
          </AnimatedButton>
        </motion.div>
      </div>
    </section>
