...
//     return (
//       <section ref={certificationsRef} id="certifications" className="py-20 bg-gradient-to-br from-surface-main to-background dark:from-yellow-900/20 dark:to-background">
...
//                 <Award className="w-12 h-12 text-ink-caption" />
//               </div>
...
//   return (
//     <section ref={certificationsRef} id="certifications" className="py-20 text-justify bg-gradient-to-br from-surface-main to-background dark:from-yellow-900/20 dark:to-background">
...
//                   className="text-xl text-brand-gold mb-4 max-w-3xl mx-auto bg-white/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-2 w-full text-center"
...
//                 <p className="text-xl text-brand-gold mb-4 max-w-3xl mx-auto">
//                   {displayData.subtitle}
//                 </p>
//               )}
...
//                                   className="bg-white/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-1 text-lg w-full"
//                                   placeholder="Issuer"
...
//                                   className="bg-white/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-1 text-lg w-20"
//                                   placeholder="Date"
...
//                             className="w-full bg-white/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-2 text-muted-foreground mb-6 leading-relaxed"
//                             rows={4}
...
//                             className="w-full bg-white/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-2"
...
//                           className="inline-flex items-center text-brand-gold hover:text-brand-yellow transition-colors group"
//                         >
...
//                       <Award className="w-16 h-16 text-ink-caption mx-auto mb-4" />
...
//                   <Award className="w-8 h-8 text-ink-caption" />
//                 </div>
...
export function Certifications({
  ...
  if (!isEditing && !hasData) {
    return (
      <section
        ...
        id="certifications"
        className="py-20 bg-gradient-to-br from-surface-main to-background dark:from-yellow-900/20 dark:to-background"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Edit Controls */}
          <div className="text-right mb-8">
  ...
  return (
    <section
      ref={certificationsRef}
      id="certifications"
      className="py-20 text-justify bg-gradient-to-br from-surface-main to-background dark:from-yellow-900/20 dark:to-background"
    >
      {/* Image Cropper Modal */}
      {showCropper && (
        <motion.div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {isEditing ? (
            <>
              <div className="relative">
                <input
                  ...
                  value={displayData.subtitle || ""}
                  onChange={(e) => updateHeader("subtitle", e.target.value)}
                  className="text-xl text-brand-gold mb-4 max-w-3xl mx-auto bg-white/80 dark:bg-black/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-2 w-full text-center"
                  placeholder="Subtitle (e.g., Professional Credentials)"
                  maxLength={TEXT_LIMITS.SUBTITLE}
                />
                <div className="absolute right-2 top-1/2 transform -translate-y-1/2 text-xs text-ink-caption">
              ...
              <div className="relative">
                <textarea
                  value={displayData.description || ""}
                  onChange={(e) => updateHeader("description", e.target.value)}
                  className="text-lg text-muted-foreground max-w-3xl mx-auto bg-white/80 dark:bg-black/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-2 w-full"
                  rows={2}
                  placeholder="Description of your certifications and achievements"
                  maxLength={TEXT_LIMITS.DESCRIPTION}
                />
            ...
            <>
              {displayData.subtitle && (
                <p className="text-xl text-brand-gold mb-4 max-w-3xl mx-auto text-center">
                  {displayData.subtitle}
                </p>
              )}
              {displayData.description && (
                            ...
                            <div className="flex gap-2 w-full">
                              <div className="relative flex-1">
                                <input
                                  ...
                                  className="bg-white/80 dark:bg-black/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-1 text-lg w-full"
                                  placeholder="Issuer"
                                  maxLength={TEXT_LIMITS.CERT_ISSUER}
                                />
                                <div className="absolute right-1 top-1/2 transform -translate-y-1/2 text-xs text-ink-caption">
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  className="bg-white/80 dark:bg-black/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-1 text-lg w-20"
                                  placeholder="Date"
                                  maxLength={TEXT_LIMITS.CERT_DATE}
                                />
                                <div className="absolute right-1 top-1/2 transform -translate-y-1/2 text-xs text-ink-caption">
                      ...
                      {isEditing ? (
                        <div className="relative">
                          <textarea
                            ...
                            className="w-full bg-white/80 dark:bg-black/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-2 text-muted-foreground mb-6 leading-relaxed"
                            rows={4}
                            placeholder="Certification description"
                            maxLength={TEXT_LIMITS.CERT_DESCRIPTION}
                          />
                      ...
                      {isEditing ? (
                        <div className="relative">
                          <input
                            ...
                            className="w-full bg-white/80 dark:bg-black/80 border-2 border-dashed border-status-info/40 rounded focus:border-status-info focus:outline-none p-2"
                            placeholder="Credential URL (optional)"
                            maxLength={TEXT_LIMITS.CERT_URL}
                          />
                          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 text-xs text-ink-caption">
