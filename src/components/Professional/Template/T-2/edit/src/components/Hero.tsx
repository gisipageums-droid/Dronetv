...
export function Hero({
  ...
  const performAutoSave = useCallback(
    async (dataToSave: HeroData) => {
      try {
        ...
        console.log("Hero auto-save completed:", dataToSave);
      } catch (error) {
  ...
  const EditableText = useMemo(() => {
    ...
    return EditableTextComponent;
  }, [updateTempContent, updateButton]);
            ...
            <div className="absolute -top-4 right-4 z-20">
              {!isEditing ? (
                ...
                <div className="flex flex-col gap-2">
                  {/* Auto-save indicator */}
                  <div className="flex items-center gap-2 mr-4 text-sm bg-white/90 backdrop-blur-sm rounded p-2">
                    {isAutoSaving && (
