...
//     <div
//       className="p-6 border-2 border-status-warning/40 border-dashed bg-gradient-to-br from-ink-offwhite to-ink-light dark:from-gray-800 dark:to-gray-900 rounded-2xl dark:border-orange-600"
...
//               className="w-full p-3 bg-surface-card border border-ink-light rounded-lg dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-status-warning focus:outline-none"
//             />
//             <div
...
//             <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-status-warning">
//               <img
//                 src={formData.image}
//                 alt="Avatar preview"
...
//             rows={4}
//             className="w-full p-3 bg-surface-card border border-ink-light rounded-lg resize-none dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-status-warning focus:outline-none"
//           />
//           <div
//             className={`text-sm text-right ${getCharCountColor(
...
//             className="p-2 bg-surface-card border border-ink-light rounded-lg dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-status-warning focus:outline-none"
//           >
...
//               isUploading
//                 ? "bg-status-success cursor-not-allowed"
...
//               isUploading
//                 ? "bg-ink-caption cursor-not-allowed"
//                 : "bg-ink-caption hover:bg-ink-paragraph"
//             }`}
//           >
//             <X className="w-4 h-4" />
//             <span>Cancel</span>
...
//                   className="w-full max-w-2xl p-2 mx-auto text-4xl font-bold text-ink bg-ink-light border-2 rounded-lg lg:text-5xl dark:bg-gray-800 dark:text-white focus:border-brand-gold dark:focus:border-yellow-400 focus:outline-none"
...
//                 resetForm();
//               }}
//               className="inline-flex items-center px-6 py-3 space-x-2 text-white transition-colors bg-status-warning rounded-lg hover:bg-status-warning"
//             >
...
//                       <blockquote className="text-justify mb-6 italic leading-relaxed text-ink-paragraph dark:text-gray-300">
//                         "{testimonial.content}"
//                       </blockquote>
...
//               <div
//                 ref={containerRef}
//                 className="relative h-96 bg-ink rounded-lg overflow-hidden mb-6 cursor-move select-none"
        ...
        >
          {isEditMode ? (
            ...
            <>
              ...
              <p className="max-w-3xl mx-auto text-xl text-ink-paragraph dark:text-gray-400 text-center">
                {testimonialContent.description}
              </p>
            </>
          )}
