    ...
    <>
      <motion.div className="fixed bottom-20 right-4 sm:right-10 z-50">
        <motion.button
          ...
          className="bg-brand-gold text-ink font-semibold py-3 px-6 rounded-full shadow-lg flex items-center gap-2"
                ...
                <div className="flex items-start gap-3 p-3 bg-status-info/10 rounded-lg mb-4">
                  ...
                  <p className="text-sm text-status-info">
                    ...
                    <button
                      ...
                      className="text-status-error underline font-medium hover:text-status-error transition-colors"
                    >
      ...
      <AnimatePresence>
        {termsModel && (
          ...
          >
            ...
            >
              {/* Modal Header */}
              <div className="flex items-center justify-between p-6 border-b border-ink-light bg-surface-card sticky top-0 z-10">
                <h3 className="text-2xl font-bold text-ink">
                  Terms and Conditions
                </h3>
                <button
                  onClick={() => setTermsModel(false)}
                  className="p-2 rounded-full hover:bg-ink-light transition-colors"
                >
              ...
              <div className="flex-1 overflow-y-auto p-6">
                <div className="prose prose-lg max-w-none">
                  <pre className="whitespace-pre-wrap font-sans text-ink-paragraph text-sm leading-relaxed">
                    {termsContent}
                  </pre>
                </div>
              </div>
