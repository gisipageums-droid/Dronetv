        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              ...
              I build modern, scalable applications that make a difference.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gray-700 dark:text-white font-semibold mb-4">Quick Links</h3>
          ...
          {/* More Links */}
          <div>
            <h3 className="text-gray-700 dark:text-white font-semibold mb-4">More</h3>
            <ul className="space-y-2">
              {moreLinks.map((link) => (
                <li key={link.href}>
                  <motion.button
            ...
            {/* Newsletter Signup */}
            <div className="mt-6">
              <h4 className="text-gray-700 dark:text-white font-medium mb-2">Stay Updated</h4>
