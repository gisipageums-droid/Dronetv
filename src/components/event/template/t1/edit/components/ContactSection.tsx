...
const ContactSection: React.FC<ContactSectionProps> = ({ id }) => {
  ...
  return (
    <section id="contact" className="py-20 bg-ink-offwhite">
      ...
      {/* Contact Form */}
      <div className="max-w-4xl mx-auto bg-surface-card shadow-xl rounded-2xl p-10">
        <form
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-ink-light rounded-lg px-4 py-3"
            />
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <select className="border border-ink-light rounded-lg px-3">
                <option>+91</option>
              </select>
              ...
              <input
                ...
                className="flex-1 border border-ink-light rounded-lg px-4 py-3"
              />
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <textarea
              ...
              className="w-full border border-ink-light rounded-lg px-4 py-3 h-32"
            />
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            <button
              type="submit"
              className="w-full bg-[#003D73] text-white font-bold py-3 rounded-lg hover:bg-status-info transition-all"
            >
              Submit
            </button>
          </div>
