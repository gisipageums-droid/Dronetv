  ...
  return (
    <section className="py-16 bg-ink text-white">
      <div className="container mx-auto px-4 text-center">
        <div data-aos="fade-up" className="inline-block bg-[#F8C400] text-ink text-xs font-bold uppercase tracking-widest px-4 py-1 rounded-full mb-6">
          Upcoming
        </div>

        <h2 data-aos="fade-up" data-aos-delay="100" className="text-3xl md:text-4xl font-bold mb-4">
          Curtain Raiser — <span className="text-[#F8C400]">Drone Expo 2026</span>
        </h2>

        <div data-aos="fade-up" data-aos-delay="200" className="w-20 h-1 bg-[#DC2626] mx-auto mb-8"></div>

        <div data-aos="fade-up" data-aos-delay="300" className="flex flex-wrap justify-center gap-8 mb-10 text-ink-light">
          <div className="flex items-center gap-2">
            <Calendar size={18} className="text-[#F8C400]" />
            <span>26th February 2026</span>
          </div>
          <div className="flex items-center gap-2">
            <MapPin size={18} className="text-[#F8C400]" />
            <span>Bengaluru</span>
          </div>
          <div className="flex items-center gap-2">
            <Video size={18} className="text-[#F8C400]" />
