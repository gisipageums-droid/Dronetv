  ...
  const [AIGenData, setAIGenData] = useState<any>({
    ...
    content: {
      ...
      hero: {
        ...
        description:
          "We believe in turning bold ideas into lasting impact. ahcbshj delivers solutions that blend technology, creativity, and purpose. Driving innovation that shapes industries and communities.",
        ...
        numberOfClients: "500",
        clientImage1:
          "https://images.unsplash.com/photo-1473968512647-3e447244af8f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1200&q=80",
        clientImage2:
          "https://images.unsplash.com/photo-1473968512647-3e447244af8f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1200&q=80",
        clientImage3:
          "https://images.unsplash.com/photo-1473968512647-3e447244af8f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1200&q=80",
      ...
      about: {
        ...
        description1:
          "ahcbshj was founded by asnclakwnjl with a vision to revolutionize data acquisition using safe and reliable drone technology. Their initial focus was on developing precise aerial photography solutions, quickly expanding",
        description2:
          "to encompass a wider range of applications. The founding team's combined expertise in aerospace engineering and software development proved invaluable",
        mission:
          "To provide safe, reliable, and innovative drone technology solutions that empower businesses and organizations with precise aerial data.",
        vision:
          "To be the leading provider of cutting-edge drone technology, shaping the future of aerial data acquisition through innovation and unwavering commitment to safety.",
        officeImage: "",
        certifications: [
        ...
        services: [
          {
            ...
            detailedDescription:
              "Our alcnwlknc service combines cutting-edge technology with expert analysis to deliver exceptional results for your business needs.",
            description:
              "alcnwlknc provides professional drone technology solutions solutions using advanced technology for superior business results.",
          ...
          },
          {
            ...
            detailedDescription:
              "Our implementation services ensure smooth drone technology solutions integration with comprehensive setup and training.",
            description:
              "Complete drone technology solutions implementation services for seamless business integration.",
            timeline: "3-8 weeks depending on system complexity",
            title: "Drone Technology Solutions Implementation Services",
            category: "Drone Technology Solutions Services",
            pricing:
              "\u20b975,000-\u20b93,00,000 (based on implementation scope)",
          },
          {
            benefits: [
            ...
            detailedDescription:
              "Our maintenance services ensure your drone technology solutions systems operate at peak performance.",
            description:
              "Comprehensive drone technology solutions maintenance and support services for optimal performance.",
            timeline: "Ongoing monthly/annual support contracts",
            title: "Drone Technology Solutions Maintenance & Support",
            category: "Drone Technology Solutions Services",
            pricing:
              "\u20b915,000-\u20b950,000 per month (based on support level)",
          },
        ],
        categories: [
          "All",
      ...
      products: {
        heading: {
          ...
          description:
            "Quality drone technology solutions solutions tailored to your business needs.",
        ...
        products: [
          {
            ...
            image:
              "https://images.unsplash.com/photo-1473968512647-3e447244af8f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
            description:
              "akjcnjka - Professional-grade drone technology solutions solution for business applications.",
            features: [
              "Advanced Drone Technology Solutions Technology",
            ...
            detailedDescription:
              "The akjcnjka combines cutting-edge technology with professional reliability.",
          ...
          },
          {
            ...
            image:
              "https://images.unsplash.com/photo-1551288049-bebda4e38f71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
            description:
              "Comprehensive drone technology solutions business suite for enterprise applications.",
            features: [
            ...
            detailedDescription:
              "Complete business suite for drone technology solutions management with integrated analytics.",
          ...
          },
          {
            ...
            image:
              "https://images.unsplash.com/photo-1559827260-dc66d52bef19?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
            description:
              "Essential drone technology solutions starter package for small to medium businesses.",
            features: [
            ...
            detailedDescription:
              "Perfect starter solution for businesses new to drone technology solutions.",
      ...
      clients: {
        headline: {
          ...
          description:
            "We've worked with diverse clients across industries to deliver exceptional aerial solutions in Nagpur, MH, IN and beyond.",
        },
        clients: [
          {
            ...
            image:
              "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200",
          },
          {
            logo: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200",
            name: "AgriTech Innovations",
            image:
              "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200",
          },
          {
            ...
            image:
              "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200",
          },
          {
            ...
            image:
              "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=200",
          },
        ],
        stats: [
          {
      ...
      testimonials: {
        headline: {
          ...
          description:
            "Real experiences from clients who have transformed their operations with our drone solutions.",
        },
        testimonials: [
          {
            name: "Rajesh Kumar",
            ...
            quote:
              "ahcbshj's drone services significantly improved our site surveying process. We saw a 30% reduction in project completion time and a 15% decrease in material costs due to the increased accuracy of their data.  Their efficient data delivery was invaluable.",
          },
          {
            name: "Priya Sharma",
            rating: 5.0,
            image:
              "https://images.unsplash.com/photo-1494790108755-2616b612b786?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=400&q=80",
            role: "Operations Director, AgriTech Solutions",
            quote:
              "Using ahcbshj's agricultural drone services, we've optimized our crop monitoring and spraying.  We've seen a 10% increase in yield and a 5% reduction in pesticide usage thanks to their precise data analysis and targeted application recommendations.",
          },
          {
            name: "Amit Patel",
            rating: 5.0,
            ...
            quote:
              "ahcbshj's stunning aerial photography significantly enhanced our marketing campaigns.  We saw a 20% increase in leads and a 15% boost in property sales after incorporating their high-resolution images and videos into our brochures and online listings.",
          },
          {
            ...
            quote:
              "ahcbshj's environmental monitoring services provided highly accurate data, crucial for our compliance reports.  Their adherence to regulatory standards and the precision of their data analysis were exceptional.",
          },
        ],
        stats: [
          {
      ...
      contact: {
        ...
        description:
          "Get in touch with our drone experts at ahcbshj for a customized solution that transforms your operations.",
        ...
        questions: [
          {
            ...
            answer:
              "Yes, all our drone operations are fully DGCA compliant. We hold the necessary permits and licenses, and our pilots are certified and trained to adhere to all relevant regulations. We maintain meticulous flight logs and adhere to stringent safety protocols.",
          },
          {
            question: "What types of projects can your drones handle?",
            answer:
              "Our drones are versatile and can handle a wide range of projects, including but not limited to: high-resolution aerial photography and videography, precise surveying and mapping, infrastructure inspection, and thermal imaging.  We can tailor our services to meet your specific needs.",
          },
          {
            question: "How do you ensure data accuracy and reliability?",
            answer:
              "We utilize advanced technologies such as RTK GPS and post-processing techniques to ensure sub-centimeter accuracy in our data.  Our experienced data processing team rigorously checks and validates all data to guarantee reliability and meet the highest industry standards.",
          },
          {
            question:
              "What is your process for obtaining necessary permissions and approvals for drone flights?",
            answer:
              "We handle all necessary permissions and approvals for drone flights. This includes liaising with relevant authorities, obtaining flight permits, and ensuring compliance with all regulations. This allows our clients to focus on their projects without worrying about the regulatory aspects.",
          },
          {
            question:
              "What are the cost benefits of using ahcbshj's drone services compared to traditional methods?",
            answer:
              "Our drone services often offer significant cost savings compared to traditional methods by reducing labor costs, minimizing site disruption, and accelerating project timelines. We provide detailed cost breakdowns and proposals tailored to your specific project requirements.",
          },
          {
            question:
              "What is your insurance coverage and liability protection?",
            answer:
              "We maintain comprehensive liability insurance to protect our clients and ourselves against any potential risks associated with our drone operations. We are committed to ensuring the safety and security of all our projects.",
          },
        ],
      },
      profile: {
        ...
        description:
          "Leading drone technology solutions company delivering innovative solutions.",
        coreValues: [
