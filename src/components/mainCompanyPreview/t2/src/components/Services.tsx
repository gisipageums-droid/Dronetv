    ...
    <>
      ...
      <AnimatePresence>
        {isModalOpen && selectedServiceIndex !== null && (
          ...
          >
            <motion.div
              className="bg-card rounded-xl w-full max-w-2xl p-6 relative max-h-[85vh] overflow-y-auto"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ol className="space-y-1.5 text-sm">
                    {serviceData.services[selectedServiceIndex].process.map((p, pi) => (
                      <li key={pi} className="leading-tight">
                ...
                <div className="grid grid-cols-2 gap-4 pt-2">
                  <div>
                    ...
                    <p className="text-sm">{serviceData.services[selectedServiceIndex].pricing}</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-sm mb-1">Timeline</h3>
                    <p className="text-sm">{serviceData.services[selectedServiceIndex].timeline}</p>
                  </div>
                </div>
              </div>
            </motion.div>
