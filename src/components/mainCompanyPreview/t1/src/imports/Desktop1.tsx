import svgPaths from "./svg-l9gffq0xm3";
import imgRectangle22 from "figma:asset/3866a52e3e45a798cc702a82a2b6ef059ebc6271.png";
import imgRectangle4 from "figma:asset/dfd6d5547453d87c56538467a7e1301f788757cb.png";
import imgRectangle13 from "figma:asset/1f202b81de26dfdf46a35d7ad74ba6aa81fb5d9b.png";
import imgRectangle15 from "figma:asset/86cc7cd181eff731f0f69fa332ce828efe0c9638.png";
import imgRectangle14 from "figma:asset/60b456f21b54bd64c42ae634ce7c1b94c81a76cc.png";
import imgRectangle17 from "figma:asset/7ce53ee2e2861dd6830ca4ae90f488191435dc63.png";
import imgRectangle20 from "figma:asset/d59acd1d1e0a579596c902c43c91c02d1858f9a2.png";
import imgRectangle21 from "figma:asset/447e1fa81cfe6a4486f0dee791f28357cf56f62e.png";
import imgRectangle30 from "figma:asset/1bff3766b212c28b52d9ee5874c8ecf23be8a16d.png";
import imgRectangle36 from "figma:asset/83999b8d466bcbd2a415c7f99f10e2e46da9f25c.png";
import imgRectangle37 from "figma:asset/d4cbcf912292fc8f4ec9b463c821b966383f49c1.png";
import imgRectangle7 from "figma:asset/14c47f78da3596c84b7eeba61772007e1c6d049d.png";
import imgRectangle9 from "figma:asset/8845493438bfdce093a9eaedb86d7529dcfda9bd.png";
import imgRectangle8 from "figma:asset/035edfb5f1c3847806af0a53333339bf625e7617.png";
import imgRectangle10 from "figma:asset/bb0fddbbedc084daedf8d6c2df3a549b00fbb57d.png";
import imgRectangle40 from "figma:asset/3cf29919403d8513a5e32a017ab335157df81b4b.png";
    ...
    <div className="bg-[#ffffff] relative size-full" data-name="Desktop - 1">
      ...
      <div className="absolute h-[454px] left-10 top-[4605px] w-[1360px]">
        <div className="absolute bottom-[-1.76%] left-[-0.29%] right-[-0.29%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1368 462">
            <g filter="url(#filter0_d_1_264)" id="Rectangle 23">
              <path d="M4 0H1364V454H4V0Z" fill="var(--fill-0, #0E0B4E)" />
              <path d="M1363 1V453H5V1H1363Z" stroke="var(--stroke-0, #F5F5F5)" strokeWidth="2" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="462" id="filter0_d_1_264" width="1368" x="0" y="0">
      ...
      <div className="absolute font-['Inter:Bold',_sans-serif] font-bold h-[90px] leading-[0] left-[41px] not-italic text-[#f7efef] text-[20px] top-[541px] w-[566px]">
        <p className="leading-[normal]">At Innovative Labs, we turn bold ideas into cutting-edge solutions — blending creativity, technology, and strategy to accelerate your growth.</p>
      </div>
      ...
      <div className="absolute bg-center bg-cover bg-no-repeat h-[187px] left-[995px] rounded-[20px] top-[1927px] w-[348px]" style={{ backgroundImage: `url('${imgRectangle15}')` }} />
      <div className="absolute bg-center bg-cover bg-no-repeat h-[186px] left-[29px] rounded-[20px] top-[1928px] w-[397px]" style={{ backgroundImage: `url('${imgRectangle14}')` }} />
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[31px] leading-[0] left-[206.5px] not-italic text-[#000000] text-[16px] text-center top-[2133px] translate-x-[-50%] w-[347px]">
        <p className="leading-[normal]">Service Heading</p>
      </div>
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[31px] leading-[0] left-[1146.5px] not-italic text-[#000000] text-[16px] text-center top-[2135px] translate-x-[-50%] w-[347px]">
        <p className="leading-[normal]">Service Heading</p>
      </div>
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[31px] leading-[0] left-[701.5px] not-italic text-[#000000] text-[16px] text-center top-[2134px] translate-x-[-50%] w-[347px]">
        <p className="leading-[normal]">Service Heading</p>
      </div>
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[65px] leading-[0] left-[206px] not-italic text-[#000000] text-[16px] text-center top-[2180px] translate-x-[-50%] w-[348px]">
        <p className="leading-[normal]">
          {`Service Sub Heading `}
          <br aria-hidden="true" />
          {`Service Sub Heading Service Sub Heading Service Sub Heading Service Sub Heading `}
        </p>
      </div>
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[65px] leading-[0] left-[1169px] not-italic text-[#000000] text-[16px] text-center top-[2198px] translate-x-[-50%] w-[348px]">
        <p className="leading-[normal]">
          {`Service Sub Heading `}
          <br aria-hidden="true" />
          {`Service Sub Heading Service Sub Heading Service Sub Heading Service Sub Heading `}
      ...
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[65px] leading-[0] left-[688px] not-italic text-[#000000] text-[16px] text-center top-[2192px] translate-x-[-50%] w-[348px]">
        <p className="leading-[normal]">
          {`Service Sub Heading `}
          <br aria-hidden="true" />
          {`Service Sub Heading Service Sub Heading Service Sub Heading Service Sub Heading `}
      ...
      <div className="absolute bg-center bg-cover bg-no-repeat h-[434px] left-11 rounded-[10px] top-[2502px] w-[367px]" style={{ backgroundImage: `url('${imgRectangle17}')` }} />
      <div className="absolute bg-center bg-cover bg-no-repeat h-[434px] left-[895px] rounded-[10px] top-[2502px] w-[369px]" style={{ backgroundImage: `url('${imgRectangle20}')` }} />
      <div className="absolute bg-center bg-cover bg-no-repeat h-[434px] left-[470px] rounded-[10px] top-[2502px] w-[361px]" style={{ backgroundImage: `url('${imgRectangle21}')` }} />
      ...
      <div className="absolute h-[59px] left-[30px] top-[3294px] w-[60px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 60 59">
          <ellipse cx="30" cy="29.5" fill="var(--fill-0, #D9D9D9)" id="Ellipse 2" rx="30" ry="29.5" />
        </svg>
      </div>
      <div className="absolute h-[59px] left-[1327px] top-[3315px] w-[60px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 60 59">
          <ellipse cx="30" cy="29.5" fill="var(--fill-0, #D9D9D9)" id="Ellipse 2" rx="30" ry="29.5" />
        </svg>
      </div>
      <div className="absolute h-[59px] left-[1357px] top-[2689px] w-[60px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 60 59">
          <ellipse cx="30" cy="29.5" fill="var(--fill-0, #D9D9D9)" id="Ellipse 2" rx="30" ry="29.5" />
        </svg>
      </div>
      ...
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[27px] leading-[0] left-[107px] not-italic text-[#f7efef] text-[16px] top-[4725px] w-[457px]">
      ...
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[31px] leading-[0] left-[708px] not-italic text-[#f7efef] text-[24px] top-[4694px] w-[133px]">
        <p className="leading-[normal]">Products</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[31px] leading-[0] left-[1119px] not-italic text-[#f7efef] text-[24px] top-[4691px] w-[133px]">
        <p className="leading-[normal]">ContactUs</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[31px] leading-[0] left-[913px] not-italic text-[#f7efef] text-[24px] top-[4694px] w-[133px]">
        <p className="leading-[normal]">Services</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[774.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4752px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[775.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4807px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[774.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4856px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[1170.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4809px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[949.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4805px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[1170.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4852px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[949.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4854px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[1170.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4750px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute font-['Inter:Medium',_sans-serif] font-medium h-[34px] leading-[0] left-[949.5px] not-italic text-[#f7efef] text-[20px] text-center top-[4752px] translate-x-[-50%] w-[133px]">
        <p className="leading-[normal]">random</p>
      </div>
      <div className="absolute bg-[#d9d9d9] h-[21px] left-[940px] top-[4952px] w-[159px]" />
      <div className="absolute bg-[#d9d9d9] h-4 left-[1164px] top-[4950px] w-32" />
      <div className="absolute h-4 left-[568px] top-[3516px] w-2.5">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 16">
          <ellipse cx="5" cy="8" fill="var(--fill-0, #1C1C1C)" id="Ellipse 4" rx="5" ry="8" />
        </svg>
      </div>
      <div className="absolute h-4 left-[636px] top-[3516px] w-2.5">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 16">
          <ellipse cx="5" cy="8" fill="var(--fill-0, #D9D9D9)" id="Ellipse 6" rx="5" ry="8" />
        </svg>
      </div>
      <div className="absolute h-4 left-[602px] top-[3516px] w-2.5">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 16">
          <path d={svgPaths.pe3f3b00} fill="var(--fill-0, #D9D9D9)" id="Ellipse 5" stroke="var(--stroke-0, black)" />
        </svg>
      </div>
      ...
      <div className="absolute bg-center bg-cover bg-no-repeat h-[67px] left-[424px] opacity-40 top-[1073px] w-[260px]" style={{ backgroundImage: `url('${imgRectangle9}')` }} />
      <div className="absolute bg-center bg-cover bg-no-repeat h-[91px] left-[742px] opacity-40 top-[1061px] w-[232px]" style={{ backgroundImage: `url('${imgRectangle8}')` }} />
      <div className="absolute bg-center bg-cover bg-no-repeat h-[35px] left-[1072px] opacity-40 top-[1097px] w-[298px]" style={{ backgroundImage: `url('${imgRectangle10}')` }} />
      <div className="absolute font-['Inter:Regular',_sans-serif] font-normal h-[308px] leading-[normal] left-16 not-italic text-[#000000] text-[24px] top-[1309px] w-[658px]">
        <p className="mb-0">Company Name: Innovative Labs</p>
        <p className="mb-0">Founder / Owner: [Owner Name]</p>
        <p className="mb-0">Director: [Director Name]</p>
        <p className="mb-0">Established: [Year of Establishment]</p>
        <p className="mb-0">Headquarters: [City, Country]</p>
        <p className="mb-0">{`Industry: Technology & Innovation Solutions`}</p>
        <p className="mb-0">Mission: To create cutting-edge solutions that empower businesses through innovation and technology.</p>
        <p>Vision: To be a global leader in driving innovation that shapes a smarter, sustainable future.</p>
      </div>
      <div className="absolute bg-center bg-cover bg-no-repeat h-[374px] left-[833px] rounded-[20px] top-[1258px] w-[537px]" style={{ backgroundImage: `url('${imgRectangle40}')` }} />
      <div className="absolute bg-[#d9d9d9] h-12 left-[139px] rounded-[20px] top-[4072px] w-[425px]" />
      <div className="absolute bg-[#d9d9d9] h-[65px] left-[142px] rounded-[20px] top-[4220px] w-[422px]" />
    </div>
  );
}