                  ...
                  {isEditing && (
                    ...
                    >
                      <input
                        type="file"
                        accept="image/*"
                        className="w-full text-xs cursor-pointer font-bold text-white" // ADDED: text-white for better contrast
                        onChange={(e) => handleGalleryImageSelect(index, e)}
                      />
                      {pendingImages[index] && (
                        <p className="text-xs text-green-400 mt-1 text-center"> {/* CHANGED: text-green-600 to text-green-400 for better visibility on dark background */}
                          ✓ Image cropped and ready to upload
                        </p>
                      )}
                    </motion.div>
