...
// //           />
// //         ) : (
// //           <span className="text-muted-foreground text-center w-full">{feature}</span>
// //         )}
// //       </div>
// //     ))}
// //     {isEditing && (
...
//   // Add cleanup effect to reset cropper state
//   useEffect(() => {
//     return () => {
//       // Reset cropper states when component unmounts or editing changes
//       setShowCropper(false);
//       setImageToCrop(null);
//       setOriginalFile(null);
//       setCrop({ x: 0, y: 0 });
...
//   // Cancel cropping - enhanced to reset all states
//   const cancelCrop = () => {
//     setShowCropper(false);
//     setImageToCrop(null);
//     setOriginalFile(null);
...
//   return (
//     <>
//       {/* Image Cropper Modal - Fixed with proper conditions */}
