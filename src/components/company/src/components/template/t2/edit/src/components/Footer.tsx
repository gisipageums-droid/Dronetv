    ...
    try {
      if (!userId || !publishedId || !templateSelection) {
        ...
        return null;
            ...
            const __presignedUrl = await uploadCompanyImagePresigned(userId, `logoUrl.${Date.now()}`, file);
      ...
      >
        ...
        <div className="absolute top-4 right-4 z-10">
          {!isEditing ? (
            <Button
              onClick={handleEdit}
              className="bg-brand-yellow hover:bg-brand-gold text-ink"
              size="sm"
            >
        ...
        >
          ...
          >
            ...
            <div className="p-4 border-b border-ink-light flex justify-between items-center bg-ink-offwhite">
              ...
              >
                <XIcon className="w-5 h-5 text-ink-paragraph" />
              </button>
            </div>
