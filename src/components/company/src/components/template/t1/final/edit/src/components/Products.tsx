...
export default function EditableProducts({
  ...
  }, [isEditing, tempContent, pendingImages, userId, publishedId, templateSelection]);
  ...
  const updateProductField = (productId, field, value) => {
    ...
    scheduleAutoSave(); // Trigger auto-save on product field update
  };
  ...
  const updateFeature = (productId, fIndex, value) => {
    ...
    scheduleAutoSave(); // Trigger auto-save on feature update
  };
  ...
  const addFeature = (productId) => {
    ...
    scheduleAutoSave(); // Trigger auto-save for new feature
  };
  ...
  const removeFeature = (productId, fIndex) => {
    ...
    scheduleAutoSave(); // Trigger auto-save for feature removal
  };
  ...
  const addProduct = () => {
    ...
    scheduleAutoSave(); // Trigger auto-save for new product
  };
  ...
  const removeProduct = (productId) => {
    ...
    scheduleAutoSave(); // Trigger auto-save for product removal
  };
  ...
  const addCategory = () => {
    ...
    if (newCategory && !tempContent.categories.includes(newCategory)) {
      ...
      scheduleAutoSave(); // Trigger auto-save for new category
    }
  };
  ...
  const removeCategory = (categoryToRemove) => {
    ...
    scheduleAutoSave(); // Trigger auto-save for category removal
  };
    ...
    () =>
      ({
        ...
        const handleChange = (newValue: string) => {
          onChange(newValue);
          scheduleAutoSave(); // Trigger auto-save on any text change
        };
  ...
  const updateBenefitField = (index, field, value) => {
    ...
    scheduleAutoSave(); // Trigger auto-save on benefit field update
  };
  ...
  const addBenefit = () => {
    ...
    scheduleAutoSave(); // Trigger auto-save for new benefit
  };
  ...
  const removeBenefit = (index) => {
    ...
    scheduleAutoSave(); // Trigger auto-save for benefit removal
  };
