                ...
                >
                    ...
                    <div className="max-w-4xl w-full max-h-full">
                        ...
                        <div className="text-white text-center mt-4">
                            ...
                            <p className="text-ink-light">{galleryData.images?.[selectedImage]?.category}</p>
                            <p className="text-ink-caption text-sm mt-2">{galleryData.images?.[selectedImage]?.description}</p>
                        </div>
                    </div>
                </motion.div>
            )}
