...
export function Certifications({ certificationsData }: CertificationsProps) {
      ...
      <section id="certifications" className="py-20 bg-gradient-to-br from-surface-main to-background dark:from-yellow-900/20 dark:to-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="h-8 bg-ink-light rounded w-1/2 mx-auto mb-4"></div>
            <div className="h-4 bg-ink-light rounded w-2/3 mx-auto"></div>
          </div>
          <div className="relative max-w-5xl mx-auto">
            <div className="animate-pulse relative h-96 overflow-hidden rounded-2xl bg-ink-light shadow-2xl"></div>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 max-w-4xl mx-auto">
            {[...Array(4)].map((_, index) => (
              <div key={index} className="text-center">
                <div className="h-8 bg-ink-light rounded w-16 mx-auto mb-2"></div>
  ...
  return (
    <section id="certifications" className="py-20 text-justify bg-gradient-to-br from-surface-main to-background dark:from-yellow-900/20 dark:to-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <motion.div
