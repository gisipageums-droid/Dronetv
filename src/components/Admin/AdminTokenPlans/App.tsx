...
import { addUpdatePlan, deletePlan as deletePlanApi, updateTokenPrice, fetchPlans } from './api';
...
function App() {
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case 'token-price':
        return <TokenPriceSettings tokenPriceINR={tokenPriceINR} setTokenPriceINR={handleUpdateTokenPrice} />;
      case 'one-time':
        return <PlanManager 
          type="one-time" 
