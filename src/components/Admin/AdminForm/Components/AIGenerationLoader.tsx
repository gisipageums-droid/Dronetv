...
export const AIGenerationLoader: React.FC<AIGenerationLoaderProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-ink via-status-info to-status-info flex items-center justify-center z-50 overflow-y-auto py-8">
      <div className="max-w-md w-full mx-4">
        ...
        <div className="mb-8">
          ...
          <div className="w-full bg-ink-paragraph rounded-full h-3">
            <div
              className="bg-gradient-to-r from-status-info to-brand-gold h-3 rounded-full transition-all duration-300 ease-out"
