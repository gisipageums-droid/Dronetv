...
//   return (
//     <section id="portfolio" className="py-20 bg-surface-card dark:bg-gray-900">
...
//           <div className="flex flex-wrap gap-2 p-2 bg-ink-light dark:bg-gray-800 rounded-full">
...
//                   <p className="text-ink-light text-sm mb-4 line-clamp-2">{project.description}</p>
...
//             <div className="bg-surface-card dark:bg-gray-900 rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
...
//                   className="absolute top-6 right-6 w-12 h-12 bg-ink/50 rounded-full flex items-center justify-center text-white hover:bg-ink-charcoal/70 transition-colors"
//                 >
//                   <X size={20} />
//                 </button>
//               </div>
...
//                 <p className="text-ink-paragraph dark:text-gray-400 mb-6 text-lg leading-relaxed">
//                   {selectedProject.description}
//                 </p>
                
//                 <div className="mb-8">
//                   <h3 className="text-lg font-semibold text-ink dark:text-white mb-3">Technologies Used:</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            ...
            >
              ...
              />
              <div className="p-4 bg-surface-card dark:bg-gray-800">
