...
const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  <section className="w-full py-16 md:py-24 bg-[#F8C400] relative" style={{ minHeight: '100vh' }}>
    ...
    <div className="pointer-events-none absolute inset-0 opacity-10 select-none z-0">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-[#DC2626] rounded-full blur-3xl opacity-50"></div>
    </div>
        ...
        {services.map((service, idx) => (
          ...
          >
            ...
            <div className="relative z-10 text-center">
              {/* Icon Container */}
              <div className="inline-flex items-center justify-center w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-[#DC2626] to-[#DC2626]/80 rounded-2xl mb-6 shadow-xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
              ...
              {/* Title */}
              <h3 className="text-2xl lg:text-3xl font-bold text-ink mb-4 group-hover:text-[#DC2626] transition-colors duration-300">
                {service.title}
              </h3>
              {/* Description */}
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-1 bg-gradient-to-r from-[#F8C400] to-[#DC2626] group-hover:w-20 transition-all duration-500 rounded-full"></div>
          </div>
        ))}
      </div>
