              ...
              <div className="container mx-auto px-4">
                ...
                <div className="max-w-4xl mx-auto text-center">
                  <div className={`w-32 h-32 ${isTemplate2 ? 'bg-ink-charcoal' : 'bg-ink-light'} rounded-full mx-auto mb-8 flex items-center justify-center`}>
                    <span className={`${isTemplate2 ? 'text-ink-caption' : 'text-ink-caption'}`}>Image</span>
                  </div>
                ...
                <div className="container mx-auto px-4">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {formData.products.map((product: any, index: number) => (
                      <div key={index} className={`${isTemplate2 ? 'bg-ink border border-ink-charcoal' : 'bg-surface-card'} rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow`}>
                        <div className={`h-48 ${isTemplate2 ? 'bg-ink-charcoal' : 'bg-ink-light'} flex items-center justify-center`}>
                          <span className={`${isTemplate2 ? 'text-ink-caption' : 'text-ink-caption'}`}>Product Image</span>
                        </div>
                        <div className="p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    {formData.testimonials.map((testimonial: any, index: number) => (
                      <div key={index} className={`${isTemplate2 ? 'bg-ink' : 'bg-surface-card'} rounded-lg p-6 shadow-lg`}>
                        ...
                        <div className="flex items-center gap-4">
                          <div className={`w-12 h-12 ${isTemplate2 ? 'bg-ink-charcoal' : 'bg-ink-light'} rounded-full flex items-center justify-center`}>
                            <span className={`${isTemplate2 ? 'text-ink-caption' : 'text-ink-caption'} text-xs`}>Photo</span>
                          </div>
                          <div>
                            <h4 className={`font-semibold ${isTemplate2 ? 'text-white' : 'text-ink'}`}>{testimonial.name}</h4>
                            <p className={`text-sm ${isTemplate2 ? 'text-ink-caption' : 'text-ink-caption'}`}>{testimonial.role}</p>
                          </div>
                        </div>
                      </div>
                    ))}
            ...
            <section className={`py-20 ${isTemplate2 ? 'bg-ink' : 'bg-surface-card'}`}>
              <div className="container mx-auto px-4">
                ...
                <div className="grid lg:grid-cols-2 gap-16">
                  <div className={`${isTemplate2 ? 'bg-ink' : 'bg-ink-offwhite'} rounded-lg p-8`}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h4 className={`font-semibold ${isTemplate2 ? 'text-white' : 'text-ink'}`}>Address</h4>
                          <p className={`${isTemplate2 ? 'text-ink-caption' : 'text-ink-paragraph'}`}>{formData.address || 'Your Company Address'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
