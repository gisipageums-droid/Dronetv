        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {highlights.map((highlight, index) => (
            <div 
              ...
              className="group relative bg-ink/50 backdrop-blur-sm rounded-3xl p-8 border border-ink-charcoal hover:border-[#F8C400]/50 transition-all duration-500 transform hover:scale-105 overflow-hidden"
            >
              {/* Gradient Background */}
              ...
              <div className="relative z-10">
                ...
                {/* Content */}
                <h3 className="text-xl font-bold text-[#F8C400] mb-4 group-hover:text-white transition-colors">
                  {highlight.title}
                </h3>
                ...
                <div className="mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="flex items-center gap-2 text-[#DC2626] font-semibold">
                    ...
                    <div className="w-0 group-hover:w-6 h-0.5 bg-[#DC2626] transition-all duration-300"></div>
                    <span>→</span>
                  </div>
                </div>
              </div>
              ...
              {/* Animated Border */}
              <div className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-[#F8C400]/30 transition-colors duration-500"></div>
            </div>
          ))}
        </div>
