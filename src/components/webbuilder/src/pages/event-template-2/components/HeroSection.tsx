  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-ink via-ink to-ink">
        ...
        <div className="absolute inset-0">
          {[...Array(20)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-2 bg-[#F8C400] rounded-full animate-pulse opacity-30"
              style={{
      ...
      <div className="absolute top-1/4 right-1/4 opacity-10 animate-float">
        <svg width="300" height="200" viewBox="0 0 300 200" className="text-[#F8C400]">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <div 
            data-aos="fade-up" 
            data-aos-delay="300"
            className="inline-flex items-center gap-2 bg-[#DC2626]/20 border border-[#DC2626] rounded-full px-6 py-2 mb-8"
          >
            <div className="w-2 h-2 bg-[#DC2626] rounded-full animate-pulse"></div>
            <span className="text-[#DC2626] font-semibold">Limited Passes Available</span>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3">
              <Users size={20} className="text-[#F8C400]" />
          ...
          >
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-[#DC2626] mb-2">20+</div>
      ...
      {/* Floating Elements */}
      <div className="absolute top-1/3 left-1/4 w-4 h-4 bg-[#DC2626] rounded-full animate-ping opacity-75"></div>
      <div className="absolute top-1/2 right-1/3 w-2 h-2 bg-[#F8C400] rounded-full animate-pulse"></div>
