        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {categories.map((category) => (
              ...
              >
                {!category.available && (
                  <div className="absolute inset-0 bg-ink-light/80 rounded-2xl flex items-center justify-center">
                    <span className="bg-ink-paragraph text-white px-4 py-2 rounded-full text-sm font-semibold">
                      Coming Soon
                    </span>
                  </div>
                )}
          ...
          <div className="mt-20 bg-[#FFD400] rounded-3xl p-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-ink/80">Customize every aspect of your portfolio with our intuitive form builder</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-ink/80">Choose from beautifully designed templates optimized for conversions</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-ink/80">See your changes in real-time with our live preview feature</p>
              </div>
            </div>
          </div>
        </div>
